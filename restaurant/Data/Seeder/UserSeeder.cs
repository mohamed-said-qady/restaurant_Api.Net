...
namespace restaurant.Data.Seeder
{
    public class UserSeeder
    {
        ...
        {
            await CreateUserIfNotExists(email: "admin@restaurant.com",password: "Admin@123",role: Roles.Admin);

            await CreateUserIfNotExists(email: "chef@restaurant.com", password: "Chef@123",role: Roles.Chef);
        }
